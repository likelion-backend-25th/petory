...
| species       | VARCHAR(50)  | NOT NULL                      | 종족(개, 고양이 등)                         |
...
| profile_image | VARCHAR(255) | NULL                          | 프로필 사진 S3 URL                        |
...
| member_id          | BIGINT       | NOT NULL, FK(member.id ON DELETE CASCADE)             | 작성자 ID                           |
...
### 1.2.12 missing_pet_post(실종 신고 게시글)
| 컬럼명                | 데이터 타입         | 제약 조건                                                                                                                                            | 설명                   |
|:-------------------|:---------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------|
...
### 1.2.13 missing_pet_report(실종 동물 목격 제보)
| 컬럼명                 | 데이터 타입          | 제약 조건                                                                          | 설명                              |
|:--------------------|:----------------|:-------------------------------------------------------------------------------|:--------------------------------|
| id                  | BIGINT          | PK, AUTO_INCREMENT                                                             | 실종 신고 게시글 고유 ID                 |
